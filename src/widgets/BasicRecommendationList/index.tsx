...
export const RecommendationList = (props: RecommendationListProps): JSX.Element => {
  const { title, productsToDisplay = 3, displayAddToCard, displaySku, displayQuickView, ...restProps } = props;
  const {
